...
<div class="register_pannel">
		...
		<form>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter Company Name"  required  />
				</div>
			</div>	
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="company" class="form-control" placeholder="Enter Phone Number1" required />
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<label>	Phone 2</label>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter Phone Number2"  />
				</div>
			</div>	
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="company" class="form-control" placeholder="Enter Fax  Number1"  />
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<label>	Fax 2</label>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter Fax Number2"  />
				</div>
			</div>			
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="company" class="form-control"  placeholder="Enter Pan card"  />
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
